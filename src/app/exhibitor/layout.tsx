    ...
    <div className="h-screen w-full flex flex-col overflow-hidden">
      ...
      >
        ...
        {/* Avatar and Table Overlay */}
                <div className="absolute hidden md:block h-full lg:w-[25vw] md:w-[40vw] right-0 bottom-0 lg:right-[-95px] z-[100]  flex-1 max-sm:left-1/2 max-sm:-translate-x-1/2">
                  <div className="h-full w-full flex flex-col relative">
                    {/* Image of the avatar */}
                    <div className="absolute z-1 bottom-0 lg:left-[25%] md:left-[15%] max-sm:left-[5vw]">
                      <Image
                        src="/avatar.png"
                        alt="Avatar"
                        width={230}
                    ...
                    {/* Logo on the table */}
                    <div className="absolute z-10 bottom-0 md:bottom-[12vh] max-sm:bottom-[8vh] sm:landscape:bottom-[7vh] lg:left-[25%] md:left-[20%] max-sm:left-[25%]">
                      <Image
                        src="/opexn_logo.png"
                        alt="Logo"
                        width={120}
